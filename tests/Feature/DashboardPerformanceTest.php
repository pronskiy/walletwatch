...
class DashboardPerformanceTest extends TestCase
{
    ...
    public function test_dashboard_query_count_is_bounded_with_many_transactions()
    {
        // Create 1000 transactions to test performance
        ...
        // Act as user and load dashboard
        ...
        // With optimizations, query count should be bounded regardless of transaction count
        // We expect: auth, accounts, recent transactions, monthly summary, balance aggregations
        $this->assertLessThan(15, $queryCount, "Query count should be bounded: got {$queryCount} queries");
    ...
    public function test_dashboard_loads_successfully_with_optimizations()
    {
        ...
        $response->assertSee('Your Accounts');
